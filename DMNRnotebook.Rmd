...
K-Means: Validation: Used silhouette scores to find optimal clusters (k=3) but observed overlap, signaling challenges in categorical data clustering due to Euclidean distance limitations.

K-Medoids (PAM): Validation: Silhouette and elbow methods suggested k=3, but evaluation showed overlap and ambiguity in clusters. BCubed Metrics: Analyzed precision and recall, finding k=3 to strike a balance despite clustering challenges.

Insights: K-Means Limitations: Discussed challenges: categorical data's non-ordinal nature conflicts with k-means' assumptions. K-Medoids Suitability: Highlighted k-medoids as more fitting for categorical data due to medoids' usage.

Conclusion: Despite limitations, k=3 was reasonably balanced among clustering techniques for this dataset. Takeaway: Clustering categorical data is challenging; k-medoids appears more appropriate than k-means for categorical data.
...
[1]https://www.facebook.com/jason.brownlee.39, “Feature Selection with the Caret R Package,” Machine Learning Mastery, Aug. 22, 2019. https://machinelearningmastery.com/feature-selection-with-the-caret-r-package/
[1]“RPubs - Decision Tree (Gini),” rpubs.com. 
https://rpubs.com/SameerMathur/DT_Gini_CCDefault (accessed Dec. 01, 2023).
[1]Luiz Fonseca, “Clustering Analysis in R using K-means,” Medium, Aug. 15, 2019. https://towardsdatascience.com/clustering-analysis-in-r-using-k-means-73eca4fb7967
...
[1]“6.3. Preprocessing data — scikit-learn 0.23.1 documentation,” scikit-learn.org. https://scikit-learn.org/stable/modules/preprocessing.html#normalization

[1]A. Kassambara, “Determining The Optimal Number Of Clusters: 3 Must Know Methods - Datanovia,” Datanovia, 2018. https://www.datanovia.com/en/lessons/determining-the-optimal-number-of-clusters-3-must-know-methods/
